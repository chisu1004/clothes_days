package ClothesDayMaven.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "ClothesDayMaven";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/ClothesDayMaven-model"),
        mapper("/ClothesDayMaven-dao"),
        mapperxml("/ClothesDayMaven-web"),
        service("/ClothesDayMaven-service"),
        web("/ClothesDayMaven-web"),
        ;
